...
namespace AssemblyVisualizer.HAL.ILSpy
{
	...
	{
		private readonly Dictionary<AssemblyDefinition, AssemblyInfo> _assemblyCorrespondence =
			new Dictionary<AssemblyDefinition, AssemblyInfo>();

		private readonly Dictionary<EventDefinition, EventInfo> _eventCorrespondence =
			new Dictionary<EventDefinition, EventInfo>();

		private readonly Dictionary<FieldDefinition, FieldInfo> _fieldCorrespondence =
			new Dictionary<FieldDefinition, FieldInfo>();

		private readonly Dictionary<MethodDefinition, MethodInfo> _methodCorrespondence =
			new Dictionary<MethodDefinition, MethodInfo>();

		private readonly Dictionary<ModuleDefinition, ModuleInfo> _moduleCorrespondence =
			new Dictionary<ModuleDefinition, ModuleInfo>();

		private readonly Dictionary<PropertyDefinition, PropertyInfo> _propertyCorrespondence =
			new Dictionary<PropertyDefinition, PropertyInfo>();

		private readonly Dictionary<TypeDefinition, TypeInfo> _typeCorrespondence = new Dictionary<TypeDefinition, TypeInfo>();
		...
		public TypeInfo Type(TypeDefinition typeDefinition)
		{
			...
			var typeInfo = new TypeInfo
			{
				...
				MembersCount =
					methods.Count() + typeDefinition.Events.Count + typeDefinition.Properties.Count + typeDefinition.Fields.Count,

...
{
	internal class DependencyBrowserWindowViewModel : ViewModelBase
	{
		private IEnumerable<AssemblyInfo> _assemblies;
		private readonly IEnumerable<AssemblyViewModel> _assemblyViewModels;
		...
		public DependencyBrowserWindowViewModel(IEnumerable<AssemblyInfo> assemblies)
		{
			...
			Graph = CreateGraph(inputAssemblyViewModels);
			_assemblyViewModels = Graph.Vertices.ToList();
		...
		public AssemblyGraph Graph { get; private set; }

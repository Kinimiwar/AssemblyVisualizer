...
{
	internal class BrushProvider
	{
		private static readonly IList<BrushPair> _brushPairs = new List<BrushPair>
		{
		...
		private static readonly IList<SolidColorBrush> _brushes = new List<SolidColorBrush>
		{
		...
		public static IList<BrushPair> BrushPairs
		{
			get { return _brushPairs; }
		}

		public static IList<SolidColorBrush> SingleBrushes
		{
			get { return _brushes; }
		}

...
{
	public delegate void LayoutIterationEndedEventHandler<TVertex, TEdge>(
		object sender, ILayoutIterationEventArgs<TVertex> e)
		where TVertex : class
		where TEdge : IEdge<TVertex>;

	public delegate void LayoutIterationEndedEventHandler<TVertex, TEdge, TVertexInfo, TEdgeInfo>(
		object sender, ILayoutInfoIterationEventArgs<TVertex, TEdge, TVertexInfo, TEdgeInfo> e)
		where TVertex : class
		where TEdge : IEdge<TVertex>;
	...
	public interface ILayoutAlgorithm<TVertex, TEdge, TGraph, TVertexInfo, TEdgeInfo> :

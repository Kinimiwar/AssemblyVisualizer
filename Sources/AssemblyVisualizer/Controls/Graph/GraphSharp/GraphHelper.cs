...
namespace AssemblyVisualizer.Controls.Graph.GraphSharp
{
	public static class GraphHelper
	{
			...
			where TVertex : class
		{
			...
			var spi = typeof(TOtherEdge).GetProperty(sourcePropertyName);
			var tpi = typeof(TOtherEdge).GetProperty(targetPropertyName);
		...
		///     Delegate which converts an edge from the type <code>TOtherEdge</code>
		///     to the type <code>TEdge</code>.
		/// </param>

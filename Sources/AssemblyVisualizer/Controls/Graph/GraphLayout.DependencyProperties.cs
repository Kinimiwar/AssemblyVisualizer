...
namespace AssemblyVisualizer.Controls.Graph
{
		...
		where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
	{
		...
		public static readonly DependencyProperty AnimationDisablerVertexCountProperty =
			DependencyProperty.Register("AnimationDisablerVertexCount", typeof(int), typeof(GraphLayout<TVertex, TEdge, TGraph>),
		...
		public static readonly DependencyProperty AnimationDisablerEdgeCountProperty =
			DependencyProperty.Register("AnimationDisablerEdgeCount", typeof(int), typeof(GraphLayout<TVertex, TEdge, TGraph>),

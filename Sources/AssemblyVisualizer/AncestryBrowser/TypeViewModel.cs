...
namespace AssemblyVisualizer.AncestryBrowser
{
	...
	{
		private readonly MemberViewModel[] _events;
		private readonly MemberViewModel[] _fields;
		private bool _isExpanded;
		private IEnumerable<MemberViewModel> _members;
		private readonly MemberViewModel[] _methods;
		private readonly MemberViewModel[] _properties;
		...
		{
			Services.JumpTo(TypeInfo.MemberReference);
		}

...
namespace AssemblyVisualizer.AncestryBrowser
{
	...
	internal class AncestryBrowserWindowViewModel : ViewModelBase
	{
		private readonly IEnumerable<TypeViewModel> _ancestry;
		private bool _isAllCollapsed;
		private readonly MemberOptions _options;
		...
		{
			get { return _isAllCollapsed ? Resources.ExpandAll : Resources.CollapseAll; }
		}
		...
		public IEnumerable<AssemblyViewModel> Assemblies { get; private set; }

		public bool ShowFields
		{
			get { return _options.ShowFields; }
			set
			{
		...
		{
			get { return _options.ShowProperties; }
			set
			{
		...
		{
			get { return _options.ShowEvents; }
			set
			{
		...
		{
			get { return _options.ShowMethods; }
			set
			{
		...
		{
			get { return _options.ShowPublic; }
			set
			{
		...
		{
			get { return _options.ShowInternal; }
			set
			{
		...
		{
			get { return _options.ShowProtected; }
			set
			{
		...
		{
			get { return _options.ShowPrivate; }
			set
			{
		...
		{
			get { return _options.ShowProtectedInternal; }
			set
			{
		...
		{
			get { return _options.SearchTerm; }
			set
			{
